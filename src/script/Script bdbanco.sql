...
(3, 'empleado1', 'empleado123', '2024-01-15', true);
...
(2, 1, '12345678', '20-12345678-0', 'juan', 'perez', 'argentina', '1990-05-15', 'calle falsa 123', 'buenos aires', 'buenos aires', 'juan.perez@email.com', '123456789', true),
...
insert into prestamos (id_cliente, id_cuenta, fecha_alta, importe, cuota_mensual, cantidad_cuotas, estado) values 
(2, 1, '2024-03-01', 5000.00, 450.00, 12, true),
(3, 2, '2024-03-05', 10000.00, 900.00, 12, true),
(4, 3, '2024-03-10', 20000.00, 1800.00, 12, true);
